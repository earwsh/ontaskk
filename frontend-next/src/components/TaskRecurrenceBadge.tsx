    ...
    return (
      <span
        ...
        className={`inline-flex items-center gap-1.5 rounded-lg font-medium ${
          compact
            ? 'px-2 py-0.5 text-[10px] bg-brand-soft text-brand-ink'
            : 'px-2.5 py-1 text-xs bg-brand-soft text-brand-ink'
        }`}
      >
    ...
    return (
      <span
        ...
        className={`inline-flex items-center gap-1 rounded-lg font-medium ${
          compact
            ? 'px-1.5 py-0.5 text-[10px] bg-info-soft text-info'
            : 'px-2 py-0.5 text-xs bg-info-soft text-info'
        }`}
      >
