    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-surface">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        <div className="bg-card border border-line rounded-[20px] p-8 md:p-10">
          ...
          <h2 className="text-lg font-semibold text-fg mb-6 text-center">ورود به سیستم</h2>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 pl-10 bg-card border border-line rounded-xl text-fg placeholder-text-muted focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all duration-200"
                  dir="ltr"
                  placeholder="••••••••"
                />
                <button
                  ...
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-fg-muted hover:text-fg-secondary transition-colors cursor-pointer"
                >
                  {showPassword ? (
          ...
          <p className="text-sm text-fg-muted text-center mt-6">
            حساب کاربری ندارید؟{' '}
            <Link href="/register" className="text-brand-ink hover:text-brand transition-colors">
              ثبت نام
            </Link>
          </p>
        </div>
